  ...
  outputs = { self, nixpkgs, flake-utils, emacs-overlay }:
    flake-utils.lib.eachDefaultSystem (system:
      let
          ...
          emacs = emacs-overlay.packages.${system}.emacsPgtk.overrideAttrs (prev: {
          ...
          usedPackages = [
            ...
            { name = "smartparens"; require = ["smartparens-config"]; }
            "rainbow-delimiters"
            "expand-region"
